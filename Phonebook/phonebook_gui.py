...
def load_gui(self):
    ...
    #Define the list box with a scrollbar and grid them
    ...
    self.btn_update = tk.Button(self.master,width=12,height=2,text='Upate',command=lambda: phonebook_func.onUpdate(self))
